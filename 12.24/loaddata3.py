...
def NormalizeData():
    ...
    return Stops_sequences,TripNumber,Headway_normalization,Dwelltime_normalization

Stops_sequences,TripNumber,Headway_normalization,Dwelltime_normalization = NormalizeData()
