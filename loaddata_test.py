...
def GetAverageBBPro(NearTrips,ArrivalTime,Stops_sequence,Stopid,day,tripid):
    ...
    for day_,l in neartrips_tripid.items():
        ...
        while index_l_sorted<=len(l_sorted)-1:
            ...
            index_l_sorted+=1
        #找出neartrips_tripid中day时间相隔time_flag的tripid
        index_of_nearesttrip = index_l_sorted - 1
        tripid_of_nearesttrip = l_sorted[index_of_nearesttrip]["TripID"]
...
def Get_encoder_input(NearTrips,ArrivalTime,Stops_sequence,day,trip_seuence,index,busid,dire):
    ls = []
    ...
    for stopid in Stops_sequence:
        ...
        ls_each_stop+=GetAverageBBPro(NearTrips,ArrivalTime,Stops_sequence,stopid,day,trip_seuence[index])
        ...
        for dire in Directions:
            ...
            for day,trip_dic in ArrivalTime.items():
                ...
                while index<=len(trip_seuence)-1:
                    ...
                    Get_encoder_input(NearTrips,ArrivalTime,Stops_sequence,day,trip_seuence,index,busid,dire)
                    index+=1
