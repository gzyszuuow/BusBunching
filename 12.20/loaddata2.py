    ...
    for busid in BusIDs:
        for dire in Directions:
            ...
            while(TripIndex<=list(TripNumber.keys())[len(TripNumber.keys()) - 1]):
                ...
                stopfeatures_arr = np.array(stopfeatures_)
                headway_his_arr = np.array(headway_his)
                ls_arr = np.array(ls)
                if stopfeatures_arr.shape!=(28,11) or headway_his_arr.shape!=(6,28) or ls_arr.shape!=(1,28):
                    print(daynow)
                    
                    print(headway_his_arr.shape)
                    print(ls_arr.shape)
                    if stopfeatures_arr.shape!=(28,11):
                        print(stopfeatures_)
                        print(stopfeatures_arr.shape)
                    if headway_his_arr.shape!=(6,28):
                        print(headway_his)
                        print(headway_his_arr.shape)
                    if ls_arr.shape!=(1,28):
                        print(ls)
                        print(ls_arr.shape)
                    print("--------------------")
                    print()
...
'''
path1 = "C:\\Users\\bdu\\Desktop\\gzy\\BusBunching\\BusRoute400\\y_target_headway.npy"
path2 = "C:\\Users\\bdu\\Desktop\\gzy\\BusBunching\\BusRoute400\\X2_headways.npy"
path3 = "C:\\Users\\bdu\\Desktop\\gzy\\BusBunching\\BusRoute400\\X1_stopfeatures.npy"
